...
func SpaceAge() (s Suite) {
	s = Suite{
		...
		Description:  spaceageDescription(),
		Source:       `Partially inspired by Chapter 1 in Chris Pine's online Learn to Program tutorial.`,
		SourceUrl:    "http://pine.fm/LearnToProgram/?Chapter=01",
		Expectations: spaceageExpectations(),
	}
	return
}

func spaceageDescription() string {
	return `Given an age in seconds, calculate how old someone would be on:
...
func spaceageExpectations() []Expectation {
