...
func QueenAttack() (s Suite) {
	s = Suite{
		...
		Description:  queenattackDescription(),
		Source:       `J Dalbey's Programming Practice problems`,
		SourceUrl:    "http://users.csc.calpoly.edu/~jdalbey/103/Projects/ProgrammingPractice.html",
		Expectations: queenattackExpectations(),
	}
	return
}

func queenattackDescription() string {
	return `In the game of chess, a queen can attack pieces which are on the same row,
column, or diagonal.
...
func queenattackExpectations() []Expectation {
