...
func SimpleCipher() (s Suite) {
	s = Suite{
		Name:         "simple-cipher",
		Blurb:        `Implement a simple shift cipher like Caesar and a more secure substitution cipher`,
		Description:  simplecipherDescription(),
		Source:       `Substitution Cipher at Wikipedia`,
		SourceUrl:    "http://en.wikipedia.org/wiki/Substitution_cipher",
		Expectations: simplecipherExpectations(),
	}
	return
}

func simplecipherDescription() string {
	return `## Step 1
...
func simplecipherExpectations() []Expectation {
