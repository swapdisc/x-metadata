...
func PhoneNumber() (s Suite) {
	s = Suite{
		...
		SourceUrl:    "http://tutorials.jumpstartlab.com/projects/eventmanager.html",
		Expectations: phonenumberExpectations(),
	}
	return
}

func phonenumberDescription() string {
...
func phonenumberExpectations() []Expectation {
