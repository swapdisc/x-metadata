...
func CryptoSquare() (s Suite) {
	s = Suite{
		Name:         "crypto-square",
		Blurb:        `Implement the classic method for composing secret messages called a square code.`,
		Description:  cryptosquareDescription(),
		Source:       `J Dalbey's Programming Practice problems`,
		SourceUrl:    "http://users.csc.calpoly.edu/~jdalbey/103/Projects/ProgrammingPractice.html",
		Expectations: cryptosquareExpectations(),
	}
	return
}

func cryptosquareDescription() string {
	return `The input is first normalized: The spaces and punctuation are removed from the
...
func cryptosquareExpectations() []Expectation {
