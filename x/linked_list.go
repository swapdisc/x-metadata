...
func LinkedList() (s Suite) {
	s = Suite{
		...
		Expectations: linkedlistExpectations(),
	}
	return
}

func linkedlistDescription() string {
	return `In simple-linked-list we created a push-down stack using a purely
...
func linkedlistExpectations() []Expectation {
