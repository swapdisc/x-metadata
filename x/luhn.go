...
func Luhn() (s Suite) {
	s = Suite{
		...
		Description:  luhnDescription(),
		Source:       `The Luhn Algorithm on Wikipedia`,
		SourceUrl:    "http://en.wikipedia.org/wiki/Luhn_algorithm",
		Expectations: luhnExpectations(),
	}
	return
}

func luhnDescription() string {
	return `The Luhn formula is a simple checksum formula used to validate a variety of identification numbers, such as credit card numbers and Canadian Social Insurance Numbers.
...
func luhnExpectations() []Expectation {
