...
func KindergartenGarden() (s Suite) {
	s = Suite{
		...
		Description:  kindergartengardenDescription(),
		Source:       `Random musings during airplane trip.`,
		SourceUrl:    "http://jumpstartlab.com",
		Expectations: kindergartengardenExpectations(),
	}
	return
}

func kindergartengardenDescription() string {
	return `The kindergarten class is learning about growing plants. The teachers thought it would be a good idea to give them actual seeds, plant them in actual dirt, and grow actual plants.
...
func kindergartengardenExpectations() []Expectation {
