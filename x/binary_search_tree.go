...
func BinarySearchTree() (s Suite) {
	s = Suite{
		Name:         "binary-search-tree",
		Blurb:        `Write a program that inserts numbers and searches in a binary tree.`,
		Description:  binarysearchtreeDescription(),
		Source:       `Josh Cheek`,
		SourceUrl:    "https://twitter.com/josh_cheek",
		Expectations: binarysearchtreeExpectations(),
	}
	return
}

func binarysearchtreeDescription() string {
	return `When we need to represent sorted data, an array does not make a good data structure.
...
func binarysearchtreeExpectations() []Expectation {
