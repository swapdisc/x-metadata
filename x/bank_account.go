...
func BankAccount() (s Suite) {
	s = Suite{
		...
		Source:       ``,
		SourceUrl:    "",
		Expectations: bankaccountExpectations(),
	}
	return
}

func bankaccountDescription() string {
	return `A bank account can be accessed in multiple ways. Clients can make deposits and
...
func bankaccountExpectations() []Expectation {
