...
func Etl() (s Suite) {
	s = Suite{
		...
		Expectations: etlExpectations(),
	}
	return
}

func etlDescription() string {
	return `This is a fancy way of saying, "We have some crufty, legacy data over in this
...
func etlExpectations() []Expectation {
