...
func RobotSimulator() (s Suite) {
	s = Suite{
		Name:         "robot-simulator",
		Blurb:        `Write a robot simulator.`,
		Description:  robotsimulatorDescription(),
		Source:       `Inspired by an interview question at a famous company.`,
		SourceUrl:    "",
		Expectations: robotsimulatorExpectations(),
	}
	return
}

func robotsimulatorDescription() string {
	return `## Step 1
...
func robotsimulatorExpectations() []Expectation {
