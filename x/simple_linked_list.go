...
func SimpleLinkedList() (s Suite) {
	s = Suite{
		Name:         "simple-linked-list",
		Blurb:        `Write a simple linked list implementation that uses Elements and a loop`,
		Description:  simplelinkedlistDescription(),
		Source:       `Inspired by 'Data Structures and Algorithms with Object-Oriented Design Patterns in Ruby', singly linked-lists.`,
		SourceUrl:    "http://www.brpreiss.com/books/opus8/html/page96.html#SECTION004300000000000000000",
		Expectations: simplelinkedlistExpectations(),
	}
	return
}

func simplelinkedlistDescription() string {
	return `The linked list is a fundamental data structure in computer science, often used in the implementation of other data structures. They're pervasive in functional programming languages, such as Clojure, Erlang, or Haskell, but far less common in imperative languages such as Ruby or Python.
...
func simplelinkedlistExpectations() []Expectation {
