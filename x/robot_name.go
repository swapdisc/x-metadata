...
func RobotName() (s Suite) {
	s = Suite{
		Name:         "robot-name",
		Blurb:        `Write a program that manages robot factory settings.`,
		Description:  robotnameDescription(),
		Source:       `A debugging session with Paul Blackwell at gSchool.`,
		SourceUrl:    "http://gschool.it",
		Expectations: robotnameExpectations(),
	}
	return
}

func robotnameDescription() string {
	return `When robots come off the factory floor, they have no name.
...
func robotnameExpectations() []Expectation {
