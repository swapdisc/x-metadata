...
func GradeSchool() (s Suite) {
	s = Suite{
		Name:         "grade-school",
		Blurb:        `Write a small archiving program that stores students' names along with the grade that they are in.`,
		Description:  gradeschoolDescription(),
		Source:       `A pairing session with Phil Battos at gSchool`,
		SourceUrl:    "http://gschool.it",
		Expectations: gradeschoolExpectations(),
	}
	return
}

func gradeschoolDescription() string {
	return `In the end, you should be able to:
...
func gradeschoolExpectations() []Expectation {
